...
GO
ALTER VIEW dbo.iT11_02_Contractual_Hours
AS
SELECT
...
WHERE P.PERSON_STATUS NOT LIKE 'L%'
	AND D.IS_MASTER = 'Y'
	--AND A.APPOINTED_HOURS <> COALESCE(X.STANDARD_HOURS, 0)
	-- not sure about this
	AND A.APPOINTED_HOURS <> 35
	AND A.APPOINTED_HOURS > 0
	AND
	(
